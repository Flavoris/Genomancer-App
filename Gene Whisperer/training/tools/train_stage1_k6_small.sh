#!/usr/bin/env bash
#
# train_stage1_k6_small.sh - Lightweight Stage 1 training for k=6
#
...
#
# Usage:
#   ./tools/train_stage1_k6_small.sh [--overfit_debug] [--config CONFIG_PATH]
#
...
echo "============================================================"
echo "STAGE 1 TRAINING - k=6 SMALL (Lightweight)"
echo "============================================================"
...
echo "  checkpoint_name=stage1_k6.pt"
echo "============================================================"
...
python train_stage1.py \
    ...
    --tcn_hidden 192 \
    --multiscale_channels 48 \
    --checkpoint_name stage1_k6.pt \
    "${EXTRA_ARGS[@]+"${EXTRA_ARGS[@]}"}"

echo ""
echo "============================================================"
echo "STAGE 1 k=6 SMALL TRAINING COMPLETE"
echo "============================================================"
